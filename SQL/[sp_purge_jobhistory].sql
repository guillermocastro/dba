...
/****** Object:  Job [[sp_purge_jobhistory]]    Script Date: 05/08/2021 12:25:11 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 05/08/2021 12:25:11 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [sp_purge_jobhistory]    Script Date: 05/08/2021 12:25:12 ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'sp_purge_jobhistory', 
		...
		@schedule_uid=N'65e0107c-f263-4934-940f-650a1dc644dd'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
