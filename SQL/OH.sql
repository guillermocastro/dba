USE [Admin]
GO
/****** Object:  Table [dbo].[CommandLog]    Script Date: 22/06/2024 07:42:20 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[CommandExecute]    Script Date: 22/06/2024 07:42:20 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[DatabaseBackup]    Script Date: 22/06/2024 07:42:20 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
  ----------------------------------------------------------------------------------------------------
  --// Source: V&A IT Service                                                                     //--
  ----------------------------------------------------------------------------------------------------
	--DECLARE @Token UNIQUEIDENTIFIER=NEWID()
	--DECLARE @ServerName VARCHAR(128)=@@SERVERNAME--CONVERT(VARCHAR(128),SERVERPROPERTY('MachineName'))
	--DECLARE @TaskName VARCHAR(128)='[DatabaseBackup]:'+ISNULL(@Databases,'NULL')
	--INSERT INTO [SK-SCCM-01].[Admin].[dba].[DBTask] ([Instance], [Token], [TaskName], [Event]) SELECT [Instance]=@ServerName, [Token]=@Token, [TaskName]=@TaskName, [Event]='Begin'
  ----------------------------------------------------------------------------------------------------
  --// Source: https://ola.hallengren.com                                                          //--
  ----------------------------------------------------------------------------------------------------
  ...
  --// Source: V&A IT Service                                                                     //--
  ----------------------------------------------------------------------------------------------------
  --INSERT INTO [SK-SCCM-01].[Admin].[dba].[DBTask] ([Instance], [Token], [TaskName], [Event]) SELECT [Instance]=@ServerName, [Token]=@Token, [TaskName]=@TaskName, [Event]='End'
END

GO
/****** Object:  StoredProcedure [dbo].[DatabaseIntegrityCheck]    Script Date: 22/06/2024 07:42:20 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[IndexOptimize]    Script Date: 22/06/2024 07:42:20 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
