...
/****** Object:  Job [[sp_delete_backuphistory]]    Script Date: 05/08/2021 12:24:39 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 05/08/2021 12:24:40 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [sp_delete_backuphistory]    Script Date: 05/08/2021 12:24:40 ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'sp_delete_backuphistory', 
		...
		@schedule_uid=N'980e4b92-212e-425b-ab90-971354bd65f4'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
