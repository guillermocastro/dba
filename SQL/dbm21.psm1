    ...
    function Test-Instance
    {
        ...
        process
        {
            ...
            catch
            {
                ...
                $query="UPDATE [dbm].[Instance] SET [ServerState]='Off' WHERE [InstanceId]='"+$InstanceId+"'"
            ...
            foreach ($r1 in $dt1)
            {
                ...
                try
                {
                    ...
                    foreach($r2 in $dt2)
                    {
                        ...
                        foreach ($r3 in $dt3)
                        {
                            $query="INSERT INTO [dbm].[DBTable] ([InstanceId],[DBName],[name],[rows],[reserved],[data],[index_size],[unused],[DataImportUTC]) VALUES ('"+$InstanceId+"','"+$database+"','"+$table+"',RTRIM('"+$r3.rows+"'),'"+$r3.reserved+"','"+$r3.data+"','"+$r3.index_size+"','"+$r3.unused+"','"+$datetime+"')"
                            $connectionstring=Get-ConnectionString -server $env:DBMSVR -database $env:DBMDB
